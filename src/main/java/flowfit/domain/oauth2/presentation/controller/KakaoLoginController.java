...
public class KakaoLoginController {
    ...
    @GetMapping("/callback")
    public void login(@RequestParam("code") String code,  @RequestParam(required = false) String type,
                      HttpServletResponse response) throws IOException {
        Map<String, String> tokens = KakaoLoginService.login(code,response,type);
