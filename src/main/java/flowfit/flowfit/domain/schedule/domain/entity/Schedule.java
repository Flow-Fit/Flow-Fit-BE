package flowfit.flowfit.domain.schedule.domain.entity;

import flowfit.flowfit.domain.exercisedetail.domain.entity.Exercise;
import flowfit.flowfit.domain.user.domain.entity.Role;
